'use strict';
// Filet de CARACTÉRISATION pour lib/server/housekeep.js — préparation de C2
...
const { sessionIndex, idFromPath, COMPACT_KEEP_EVENTS } = require('../../lib/server/session-index.js');
const { compactSession } = require('../../lib/server/housekeep.js');
