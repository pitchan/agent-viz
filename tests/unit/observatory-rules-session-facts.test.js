...
const r3 = require('../../lib/server/observatory/rules/r3-large-tool-output');
const r4 = require('../../lib/server/observatory/rules/r4-cross-agent-reads');
const r5 = require('../../lib/server/observatory/rules/r5-compactions');
