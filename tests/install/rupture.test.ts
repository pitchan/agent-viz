...
import { isNetgainRouterHook } from '../../src/engine/install/hook-edit.js';
import { estAvantFusion, porteQueueAvantFusion, QUEUE_HOOK, QUEUE_MCP } from '../../src/engine/install/rupture.js';
