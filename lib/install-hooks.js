...
// commande qui echoue ne laisse qu'un PreToolUse orphelin — un trou, que rien
// ne distingue d'un outil encore en vol.
const EVENTS = ['UserPromptSubmit', 'PreToolUse', 'PostToolUse', 'PostToolUseFailure', 'Stop', 'SessionStart'];
