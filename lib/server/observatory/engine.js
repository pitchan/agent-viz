...
//
// The package is intentionally absent from package.json dependencies: it is
// not published yet, and declaring it would break `npm install` for users of
// this repo. A missing engine is a normal state — the live canvas view keeps
// working and the advisor page shows the exact error.
