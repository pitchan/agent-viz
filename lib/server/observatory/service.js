...
function createObservatoryService(deps) {
  ...
  // The rules' assiette is always human — sessions humaines et machines ne se
  // mêlent jamais sans annonce (règle d'homogénéité). includeMachine only
  // ever affects the table/summary display, never what gets advised on.
