...
function createJournal({ filePath = DEFAULT_PATH, now = Date.now } = {}) {
  ...
  return {
    ...
    // compte pas comme un refus, parce que le fait est en memoire et que la
    // ligne repartira au prochain essai. Seule une cle inutilisable est un
    // refus — celle-la, aucun redemarrage ne la retrouvera, et l'appelant doit
    // pouvoir ne rien conclure d'un acquittement qui n'a pas eu lieu.
