'use strict';
// routes.ts — la surface HTTP du chien de garde.
//
...
// src/server/observatory/routes.ts. Le service arrive par un accesseur, jamais
...
//     pour de bon. Voir le PIEGE en bas de src/server/watchdog/index.ts. Sans
